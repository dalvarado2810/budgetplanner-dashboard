...
class OnPolicyClickActionProcessor : ActionProcessor<Home.State, Home.Action.PolicyMenuSelection, Home.Effect>() {
    override fun process(
        action: Home.Action.PolicyMenuSelection,
