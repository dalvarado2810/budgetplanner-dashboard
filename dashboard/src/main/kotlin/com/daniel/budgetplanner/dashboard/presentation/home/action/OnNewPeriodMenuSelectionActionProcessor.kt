...
class OnNewPeriodMenuSelectionActionProcessor :
    ActionProcessor<Home.State, Home.Action.NewPeriodMenuSelection, Home.Effect>() {
    override fun process(
        action: Home.Action.NewPeriodMenuSelection,
